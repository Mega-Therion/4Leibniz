...
def concordance : List HistoricalSource := [
  { id := "analysis-situs-1679", title := "Analysis situs", date := "1679",
    ...
    folio := some "LH XXXV, 1, 9", rank := 1, status := "source-identified-transcription-needed" },
  { id := "initia-rerum-mathematicarum-metaphysica-1715",
    ...
    folio := some "LH XXXV, 1, 15", rank := 1, status := "source-identified-transcription-needed" },
  { id := "de-progressione-dyadica-1679", title := "De progressione dyadica", date := "1679",
    ...
    folio := some "LH XXXV, 3, 2", rank := 2, status := "source-identified-transcription-needed" },
